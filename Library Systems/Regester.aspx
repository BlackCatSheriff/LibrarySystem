...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <tr>  
            <td class="auto-style4">用户名：&nbsp&nbsp&nbsp <asp:TextBox ID ="txtUsername" runat ="server" MaxLength ="20" ></asp:TextBox> 
                <asp:RegularExpressionValidator ID="RegularExpressionValidator_Username" runat="server" ErrorMessage="请输入合法用户名！" ValidationExpression ="^[a-zA-Z]\w{5,17}$" ControlToValidate ="txtUsername" ForeColor ="Red" ></asp:RegularExpressionValidator>
                <br />
                字母开头，长度在6~18之间，只能包含字符、数字和下划线<br />
            </td>  
